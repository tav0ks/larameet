...
<div class="card-header py-3">
    @if ($user->is_participant == 0)
        <div class="row ml-1 align-items-center">
            ...
            @if (isset($most_voted))
                <a class="btn btn-primary mr-2" type="button"
                    href="{{ route('topic.edit', [$meet->id, $most_voted]) }}">
            ...
            @endif
            <button class="btn btn-primary mr-2" type="button" data-toggle="modal" data-target="#reenviarTokenModal"
                aria-expanded="false" aria-controls="form-participant"> Reenviar token</button>

            {{-- //TODO @if (isset($most_voted))
                <a class="btn btn-primary mr-2" type="button"
                    href="{{ route('user.meets.mail', [$meet->id, $most_voted]) }}">
                    Email com pauta
                </a>
            @endif
            @if (isset($most_voted_list))
                <a class="btn btn-primary mr-2" type="button" data-toggle="modal" data-target="#choseMailModal">
                    Email com pauta
                </a>
            @endif Deu ruim kk --}}
        ...
        <div class="col-4">
            <div class="card" style="width: 100%; height: 100%;">
                <div class="card-body">
                    ...
                    @else
                        <h3>Olá {{ ucfirst($user->name) }}!</h3>
                        <p class="card-text">Aqui voce poderá realizar a votação para o horário em que o Meet ocorrerá!
                        </p>
                    @endif
                            ...
                            @foreach ($horarios as $horario)
                                ...
                                @if (isset($most_voted_list) && in_array($horario->id, $most_voted_list->toArray()))
                                    <div class="card border-warning"
                                        style="height: 100%; box-sizing: content-box;text-align:center;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            justify-content: center;">
                                                ...
                                                <div class="vote-buttons">
                                                    @if ($vote->value == '1')
                                                        <form
                                                            action="{{ route('vote.update', $vote->id) }}"method="POST">
                                                            @method('PUT')
                                                            @csrf
                                                            <div id="1"
                                                                class="vote custom-control custom-checkbox small">
                                                    ...
                                                    @endif
                                                    @if ($vote->value == '0')
                                                        <form action="{{ route('vote.update', $vote->id) }}"
                                                            method="POST">
                                                            @method('PUT')
                                                            @csrf
                                                            <div id="0"
                                ...
                                @if ((isset($most_voted) && $most_voted->id != $horario->id) ||
                                    (isset($most_voted_list) && !in_array($horario->id, $most_voted_list->toArray())))
                                    <div class="card" style="width: 100%; height: 100%;">
                            ...
                            @if (isset($most_voted_list))
                                @foreach ($most_voted_list as $horario_id)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button"
                                                href="{{ route('topic.edit', [$meet->id, $horario->id]) }}"
...
<div class="modal fade" id="choseMailModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body py-0">
                            ...
                            @if (isset($most_voted_list))
                                @foreach ($most_voted_list as $horario_id)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button"
                                                href="{{ route('user.meets.mail', [$meet->id, $horario->id]) }}"
                                                class="btn bg-primary btn-shadow text-white d-flex align-items-center justify-content-center modal-confirm-button">
                                                <span>Escolher</span>
                                            </a>
                                        </td>
...
<div class="modal fade" id="reenviarTokenModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('participant.mail', $meet->id) }}" method="post">
                @csrf
                <div class="modal-body py-0">
                    <div class="text-center">
                        <h5 class="mt-3 mb-0">Escolha os participantes para reenvio do token</h5>
                        <br>
                        <table class="table">
                            <thead>
                                <tr>
