        ...
        <div class="card-header py-3">
            <div class="row ml-1 align-items-center">
                <a href="{{ route('user.meets.create') }}" class="nav-link" style="padding: 0px;">
                    <button class="btn btn-primary mr-2" type="button" aria-expanded="false" aria-controls="form-horario">
                ...
                <div class="col-3">
                    <div class="card" style="width: 100%; height: 100%;">
                        <div class="card-body">
                            ...
                            <p class="card-text">Aqui voce pode coordenar os seus Meets, <br> selecione um dos Meets<?php

                             if ($user->is_participant) {
                                echo ".</p>";
                             }
                             else {
                                 echo " ou crie um novo!</p>";
                ...
                <div class="col-9">
                    <div class="card" style="width: 100%; height: 100%;">
                        <div class="card-body">
                            ...
                            @endif
                            @if ($meets->count() > 0 || $meets_participant->count() > 0)
                                <div class="owl-carousel owl-theme">
                                            ...
                                            <div class="card-body">
                                                <div class="flex-column">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <a href="{{ route('user.meets.edit', $meet->id) }}"
                                                            style="margin-left:5px;" class="btn btn-primary btn-icon-split">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-pen"></i>
                                                            </span>
                                                        </a>
                                                        <a href="{{ route('horarios.index', $meet->id) }}"
                                    ...
                                    @endforeach
                                    @foreach ($meets_participant as $meet_p)
                                        <div class="card" style="width: 250px; height: 170px;">
                                            <div class="card-body">
                                                <div class="flex-column">
                                                    <div>
                                                        <h5>Meet: {{ $meet_p->name }}</h5>
                                                    </div>
                                                    <div>
                                                        <h5>Duração: {{ $meet_p->duration_formatted }}</h5>
                                                    </div>
                                                    <div class="form-group">
                                                        <a href="{{ route('horarios.index', $meet_p->id) }}"
                                                            class="btn btn-info btn-icon-split">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-eye"></i>
                                                            </span>
