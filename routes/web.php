...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('{id}/{most_voted}/edit', [TopicController::class, 'edit'])->name('topic.edit');
    Route::put('{id}/topic', [TopicController::class, 'update'])->name('topic.update');
    Route::get('{id}/{most_voted}/topic', [TopicController::class, 'print'])->name('topic.print');
});
